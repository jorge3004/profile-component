...
export declare type UpdateableLitLikeElement = {
    updated(_?: any): void;
};
declare type States = {
    index: number;
...
export declare type DecoratedLitLikeElement = LitLikeElement & {
    __registered_states: States;
};
export declare type Reducer<T> = (state: T) => {
    [action: string]: (payload?: any | unknown | undefined) => Promise<T>;
};
export declare type StateOptions = {
    updateDefault?: boolean;
};
export declare type ReducerOptions = StateOptions & {
...
export declare type WorkflowHistory = {
    type: string;
    args: unknown[];
};
