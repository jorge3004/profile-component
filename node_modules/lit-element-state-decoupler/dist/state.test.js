...
describe("State get/set", () => {
    ...
    beforeEach(() => {
        jest.resetAllMocks();
        state = (0, state_1.useState)(litElement, initialState);
    });
    ...
    it("sets the default state up correctly for different types", () => {
        expect((0, state_1.useState)(litElement, "bla").get()).toBe("bla");
        expect((0, state_1.useState)(litElement, 3).get()).toBe(3);
    });
    ...
    describe("When state is injected", () => {
        const subscriber = jest.fn();
        let newState = { value: "changed" };
        beforeEach(() => {
            state.subscribe(subscriber);
            state.inject(newState);
        });
...
describe("State value", () => {
    ...
    it("sets the default state up correctly for different types", () => {
        expect((0, state_1.useState)(litElement, "bla").value).toBe("bla");
        expect((0, state_1.useState)(litElement, 3).value).toBe(3);
    });
    describe("When the state is published without change", () => {
        const subscriber = jest.fn();
        let currentState;
...
describe("State legacy retrieving", () => {
    ...
    it("sets the default state up correctly for different types", () => {
        expect((0, state_1.useState)(litElement, "bla").getState()).toBe("bla");
        expect((0, state_1.useState)(litElement, 3).getState()).toBe(3);
    });
    describe("When the state is published without change", () => {
        const subscriber = jest.fn();
        let currentState;
...
describe("state - state registration", () => {
    ...
    it("should retrieve the same state after an update", () => {
        ...
        const state1 = (0, state_1.useState)(litElement, initialState);
        (0, decorator_1.asUpdateableLitElement)(litElement).updated();
        const state2 = (0, state_1.useState)(litElement, initialState);
        expect(state1).toBe(state2);
        expect(state).toBe(state2);
    });
    it("should add multiple states between updateds", () => {
        const state1 = (0, state_1.useState)(litElement, "initialState");
        const state2 = (0, state_1.useState)(litElement, 42);
        (0, decorator_1.asUpdateableLitElement)(litElement).updated();
        const retrieved0 = (0, state_1.useState)(litElement, initialState);
        const retrieved1 = (0, state_1.useState)(litElement, "otherState");
        const retrieved2 = (0, state_1.useState)(litElement, 0);
        (0, decorator_1.asUpdateableLitElement)(litElement).updated();
